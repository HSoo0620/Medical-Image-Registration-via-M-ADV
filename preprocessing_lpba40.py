...
def center_crop(img, size_ratio): #80 106 80
    x, y, z = img.shape
...
def calculate_landmarks(image_path='./Dataset/LPBA40/LPBA40_rigidly_registered_pairs'):
    ...
    np.save('./Dataset/LPBA40/mapping.npy', mapping)

    return mapping


def histogram_stardardization_resample_center_crop(mapping,
                                                   input_path='./Dataset/LPBA40/LPBA40_rigidly_registered_pairs',
                                                   output_path_hs_small='./Dataset/LPBA40/LPBA40_rigidly_registered_pairs_histogram_standardization_small',
                                                   output_path_mask='./Dataset/LPBA40/LPBA40_rigidly_registered_label_pairs_small'):
    ...
    for i in list(range(1, 41, 1)):
        for j in list(range(1, 41, 1)):
            ...
            # 3. center_crop
            img_crop = center_crop(img=img_np_hs_small, size_ratio=(80, 106, 80)).swapaxes(0, 2) # h w d
...
def plot_hist(image_path_hs='./Dataset/LPBA40/LPBA40_rigidly_registered_pairs_histogram_standardization_small'):
    for i in list(range(1, 41, 1)):
        for j in list(range(1, 41, 1)):
...
if __name__ == '__main__':
    mapping = calculate_landmarks(image_path='./Dataset/LPBA40/LPBA40_rigidly_registered_pairs')
